    ...
    def main():
      while True:
        ...
        if menu == "1":
           ...
           shoe_code = input("Enter Product code - to search product: ").upper()
           shoe_object = Process_data.shoe_objects()
           ...
           updated_file_name = "inventory.txt"
           shoe_object = Process_data.shoe_objects()
           shoe = Functions.delete_shoe(shoe_object, updated_file_name, shoe_code)
        elif menu == "0":
           print("Bye!")
           exit()
